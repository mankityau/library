...
int main() {
  ...
  auto x = 10.0;                // probably don't want to use "auto" here
  ...
  // 100 instances of it.  If above you change y to be a double, this next line of code does not need to be changed.
  ...
  std::cout << "10 less than 20: " << (lt ? "true" : "false") << std::endl;
