...
#define CONDITION_BASE_NAME_SUFFIX "cb"
#define CONDITION_BASE_STORAGE_SUFFIX "cs"
#define CONDITION_BASE_BLOCK_LOCK_SUFFIX "sl"
#define CONDITION_BASE_BLOCK_QUEUE_SUFFIX "cq"
#define CONDITION_BASE_UNBLOCK_LOCK_SUFFIX "cu"
