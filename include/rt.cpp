/**
 * @file
 * @brief Paul Davies' real-time library implementation file
 *
 * Not used in these sets of labs, but may be useful for comparing
 * to notes slides.  This file must be compiled to use it, and
